...
#define STRING_CONFIG_H_AUTHOR "(Rick Shinners)" // Who made the changes.
...
#define MACHINE_UUID "301d96c4-a022-4714-b922-a0fc904a0c28"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.50   // Z offset: -below +above  [the nozzle] //RShinners: lower to move nozzle toward bed
